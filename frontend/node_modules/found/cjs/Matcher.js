...
class Matcher {
  ...
  isQueryActive(matchQuery, query) {
    ...
    return Object.entries(query).every(([key, value]) => Object.prototype.hasOwnProperty.call(matchQuery, key) ? (0, _isEqual.default)(matchQuery[key], value) : value === undefined);
  }
