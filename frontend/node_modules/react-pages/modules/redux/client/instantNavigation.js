...
export function addInstantBack(nextLocation, previousLocation, nextLocationRouteComponents, previousLocationRouteComponents) {
  var chain = instantNavigationChain; // If there is already an "instant" transition in the chain
...
export function markImmediateNavigationAsInstantBack(instantBack) {
  ...
  if (instantBack) {
    ...
    setTimeout(function () {
      return window._react_pages_instant_back_navigation = false;
    }, 0);
  }
}
