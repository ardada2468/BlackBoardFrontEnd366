...
import { goto as _goto } from '../../router';
import { DEFAULT_REDUX_EVENT_NAMING } from '../naming';
export var RESULT_ACTION_PROPERTY = 'value';
export var ERROR_ACTION_PROPERTY = 'error'; // Asynchronous middleware (e.g. for HTTP Ajax calls).
//
...
export default function asynchronousMiddleware(httpClient, reduxEventNaming, server, onError) {
...
function defaultParseError(error) {
  ...
  var errorData = isObject(error.data) ? error.data : {}; // Sets HTTP response `status` code
