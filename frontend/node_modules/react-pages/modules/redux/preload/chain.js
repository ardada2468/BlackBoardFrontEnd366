...
import { isServerSidePreloaded } from '../../client/flags'; // Returns function returning a Promise
// which resolves when all the required page `load`s are resolved.
//
// If no preloading is needed, then returns nothing.
//

export default function generatePreloadChain(preloaders, server, isInitialClientSidePreload, getState, dispatch, location, params, getCookie, preloading) {
...
export function chain_preloaders(preloaders) {
