import { html } from 'print-error'; // Outputs an error page
...
export default function renderError(error, options) {
  ...
  console.log('[react-pages] Rendering service error'); // console.error(error)
...
function renderStackTrace(error, options) {
  ...
  var stack = getStackTrace(error); // If this error doesn't have a stack trace - do nothing
