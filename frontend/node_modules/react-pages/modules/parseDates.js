import { isObject } from './helpers'; // ISO 8601 date regular expression
...
export var ISO_date_regexp = "".concat(year, "-").concat(month, "-").concat(day, "T").concat(time).concat(timezone);
export var ISO_date_matcher = new RegExp('^' + ISO_date_regexp + '$'); // JSON date deserializer.
//
