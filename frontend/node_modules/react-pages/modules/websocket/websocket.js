import RobustWebSocket from '../../client/robust-websocket'; // Sets up WebSocket connection.
...
export default function websocket(_ref) {
  ...
  var _websocket = new RobustWebSocket("".concat(secure ? 'wss' : 'ws', "://").concat(host, ":").concat(port), undefined, {
  ...
  var websocket = {
    ...
    listen: function listen(event_name, listener) {
      ...
      _websocket.addEventListener(event_name, enhanced_listener); // Returns `unlisten()`
