...
var _createHistoryProtocol = _interopRequireDefault(require("../../router/server/createHistoryProtocol"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            store = (0, _store["default"])(settings, initialState, function () {
              return (0, _createHistoryProtocol["default"])(url);
            }, httpClient, {
...
function _generateJavascript(store, settings) {
  ...
  code += "<script>";
  code += "window._redux_state = JSON.parse(".concat(JSON.stringify((0, _html.safeJsonStringify)(store.getState()))).concat(settings.parseDates ? ', JSON.dateParser' : '', ")");
  code += "</script>";
  return code;
