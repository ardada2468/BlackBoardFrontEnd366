...
var _instantNavigation = require("../client/instantNavigation");
      ...
      return function (event) {
        ...
        switch (event.type) {
          case _router.UPDATE_MATCH:
            ...
            if (!window._react_pages_router_rendered && !(0, _flags.isServerSidePreloaded)()) {
            ...
            var _isInstantTransition = location.action === 'POP' && previousLocation && (0, _instantNavigation.isInstantTransition)(previousLocation, location); // Set the flag for `wasInstantNavigation()`.


            (0, _instantNavigation.setInstantNavigationFlag)(_isInstantTransition); // Indicates whether an `instantBack` `<Link/>` has been clicked.
            ...
            if (!(0, _flags.isServerSidePreloaded)() && !window._react_pages_router_rendered) {// Don't show page loading indicator
          ...
          case _router._RESOLVE_MATCH:
            ...
            if (onNavigate) {
              onNavigate((0, _location.getLocationUrl)(location), location, {
                dispatch: dispatch,
                getState: getState
              });
...
function updateMetaTags(routeIndices, state, _ref2) {
  ...
  var routeChain = (0, _router.getRoutesByPath)(routeIndices, routes); // Get `<meta/>` for the route.
